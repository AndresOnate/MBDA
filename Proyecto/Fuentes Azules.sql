...
---CuentaAsociada
ALTER TABLE CuentaAsociada ADD CONSTRAINT PK_CUENTAASOCIADA PRIMARY KEY(email);
...
---filtros
ALTER TABLE filtros ADD CONSTRAINT FK_FILTROS_CONSULTAS FOREIGN KEY(Consultas_consultId) REFERENCES consultas(consultId);
