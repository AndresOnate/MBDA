...
insert into usuarios (id, email, name, createdAt) values (21, 'Stiven@.maila', 'Steven Grant', '04/01/2018');
--- cuentas
...
insert into cuentas (id, name, createdAt, suscribers, usuarios_id) values (3, 'Steven G', '03/07/2005', 27063, 98);
...
-- suscripciones
insert into suscripciones (id, createdAt, detail, cuentas_id, suscritoA) values ('', '', 'Prueba Lab 05', 2508, 133);
insert into suscripciones (id, createdAt, detail, cuentas_id, suscritoA) values ('', '', 'Steven Subs 1', 3, 1);
insert into suscripciones (id, createdAt, detail, cuentas_id, suscritoA) values ('', '', 'Steven Subs 2', 3, 2);
...
insert into suscripciones (id, createdAt, detail, cuentas_id, suscritoA) values ('', '', 'Steven Subs 3', 3, 133);

-- etapas
insert into etapas (startAt, endAt, price, status, exclusividades_id, exclusividades_order, suscripciones_id) values ('28/07/2010', null, 614483351, 'Terminada', 133, 955, 1);
insert into etapas (startAt, endAt, price, status, exclusividades_id, exclusividades_order, suscripciones_id) values ('18/11/2008', '09/06/2021', 267433811, 'Terminada', 258,675, 2);
insert into etapas (startAt, endAt, price, status, exclusividades_id, exclusividades_order, suscripciones_id) values ('02/12/2013', '02/06/2016', 94064248, 'Terminada', 383,292, 3);
insert into etapas (startAt, endAt, price, status, exclusividades_id, exclusividades_order, suscripciones_id) values ('08/12/2007', '24/06/2021', 295718347, 'Cancelada', 508,333, 4);
insert into etapas (startAt, endAt, price, status, exclusividades_id, exclusividades_order, suscripciones_id) values ('20/08/2008', null, 815069414, 'Terminada', 633, 172,5);
insert into etapas (startAt, endAt, price, status, exclusividades_id, exclusividades_order, suscripciones_id) values ('15/02/2012', '26/02/2021', 511203890, 'Terminada', 758,914, 6);
insert into etapas (startAt, endAt, price, status, exclusividades_id, exclusividades_order, suscripciones_id) values ('04/01/2006', '28/09/2017', 824847852, 'Activa', 883,571, 7);
insert into etapas (startAt, endAt, price, status, exclusividades_id, exclusividades_order, suscripciones_id) values ('04/01/2010', null, 952591658, 'Activa', 1008, 45,8);
insert into etapas (startAt, endAt, price, status, exclusividades_id, exclusividades_order, suscripciones_id) values ('26/03/2008', '06/02/2020', 696215544, 'Activa', 1133, 474, 9);
insert into etapas (startAt, endAt, price, status, exclusividades_id, exclusividades_order, suscripciones_id) values ('25/02/2014', '30/05/2020', 741785490, 'Cancelada', 1258,847, 10);
insert into etapas (startAt, endAt, price, status, exclusividades_id, exclusividades_order, suscripciones_id) values ('28/04/2022', '31/12/2022', 741785491, 'Activa', 1258,847, 2);
insert into etapas (startAt, endAt, price, status, exclusividades_id, exclusividades_order, suscripciones_id) values ('28/04/2022', '31/12/2022', 741785491, 'Activa', 1258,847,3);
-- contenido
